...
/**
 * Legacy IDE client for backward compatibility
 * @deprecated Use ClaudeVSCodeClient instead
 */
export class ClaudeIdeClient extends ClaudeVSCodeClient {
  constructor(config = {}) {
    super(config);
    console.warn('ClaudeIdeClient is deprecated. Use ClaudeVSCodeClient instead.');
  }
}
