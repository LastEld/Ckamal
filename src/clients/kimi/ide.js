...
/**
 * Legacy KimiIdeClient for backward compatibility
 * @deprecated Use KimiVSCodeClient instead
 */
export class KimiIdeClient extends KimiVSCodeClient {
  constructor(config = {}) {
    super({ ...config, mode: 'ide' });
    console.warn('KimiIdeClient is deprecated, use KimiVSCodeClient instead');
  }
}
